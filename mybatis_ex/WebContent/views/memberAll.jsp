...
<table border="1px">
<tr>
	<td>번호</td><td>ID</td><td>이름</td><td>지역</td><td>성별</td><td>취미</td><td>가입일</td>
</tr>
<c:forEach items="${member}" var="m">
<tr>
<td>${m.memberNo}</td><td>${m.memberId}</td><td>${m.memberName}</td><td>${m.memberAddr}</td><td>${m.gender}</td><td>${m.hobby}</td><td>${m.regDate}</td>
</tr>
